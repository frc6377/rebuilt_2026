...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    protected final CurrentLimitsConfigs driveCurrentLimitsConfig;
    ...
    protected ModuleIOTalonFX(
        ...
        driveCurrentLimitsConfig = driveConfig.CurrentLimits.clone();
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, driveSupplyCurrent);
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        inputs.driveSupplyCurrentValid = driveStatus.isOK();
