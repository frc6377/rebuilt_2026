...
public class ShooterConstants {
    ...
    static {
        ...
        distanceToAngularVelocity.put(Meters.of(3.18), RPM.of(3700));
        distanceToAngularVelocity.put(Meters.of(1), RPM.of(2700));
        distanceToAngularVelocity.put(Meters.of(6), RPM.of(4100));
    }
