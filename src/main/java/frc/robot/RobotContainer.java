...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand(
                "AutoEverything",
                Commands.sequence(
                        Commands.parallel(superstructure.autoSpeedShooter(drive), intake.extendAndIntakeCommand())
                                .until(superstructure::atTargetVelocity),
    ...
    private void configureButtonBindings() {
        ...
        OIController.spinUpShooter()
                .whileTrue(superstructure.aimAtHubWhileDriving(
                        drive, OIController.driveTranslationY(), OIController.driveTranslationX()));
        shootingTrigger
                .whileTrue(Commands.parallel(
                        superstructure.autoSpeedShooter(drive),
        ...
        OIController.autoAimHold()
                ...
                .whileTrue(superstructure.autoAimHoldCommand(
                        drive,
                        () -> OIController.driveTranslationY().getAsDouble(),
                        () -> OIController.driveTranslationX().getAsDouble(),
                        indexer));
        ...
        OIController.turretModeToggle()
                .toggleOnTrue(superstructure.turretModeToggleCommand(
                        drive,
                        () -> OIController.driveTranslationY().getAsDouble(),
                        () -> OIController.driveTranslationX().getAsDouble()));
    }
