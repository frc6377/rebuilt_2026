...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                switch (Constants.currentMode) {
                        case REAL:
                                ...
                                intake = new Intake(
                                                Constants.EnabledSubsystems.kExtender ? new ExtenderIOReal()
                                                                : new ExtenderIO() {
                                                                },
                                ...
                                indexer = new Indexer(Constants.EnabledSubsystems.kIndexer ? new IndexerIOReal()
                                                : new IndexerIO() {
                                                });
                        ...
                        case SIM:
                                ...
                                intake = new Intake(
                                                Constants.EnabledSubsystems.kExtender ? new ExtenderIOSim()
                                                                : new ExtenderIO() {
                                                                },
                                                Constants.EnabledSubsystems.kRoller
                                ...
                                vision = new Vision(
                                                ...
                                                new VisionIOPhotonVisionSim(
                                                                ...
                                                                driveSimulation::getSimulatedDriveTrainPose));
                                gamePieceCamera = new GamePieceCameraSim(new Transform3d(),
                                                driveSimulation::getSimulatedDriveTrainPose);
                                indexer = new Indexer(Constants.EnabledSubsystems.kIndexer ? new IndexerIOSim()
                                                : new IndexerIO() {
                                                });
                                break;
                        default:
                                ...
                                driveSimulation = null;
                                intakeSimulation = null;
                                vision = new Vision(drive, new QuestNavIO() {
                                }, new VisionIO() {
                                }, new VisionIO() {
                                });
                ...
                NamedCommands.registerCommand(
                                ...
                                PathPlannerCommands.pathfindToPose(
                                                new Pose2d(FieldConstants.Hub.topCenterPoint.toTranslation2d(),
                                                                new Rotation2d())));

                // Set up auto routines
                autoChooser = new LoggedDashboardChooser<>("Auto Choices", AutoBuilder.buildAutoChooser());
                if (Constants.currentMode == Constants.Mode.SIM) {
                        autoChooser.addOption("Shooter Tuning Sim",
        ...
        private void configureButtonBindings() {
                ...
                OIController.autoSpeedMode()
                                .onTrue(superstructure
                                                .changeManualShootingCommand(superstructure.autoChooseShootingCommand(
                                                                drive, this::driveTranslationXInput,
                                                                this::driveTranslationYInput)));
                ...
                OIController.zeroDrivebase()
                                .onTrue(PathPlannerCommands.pathfindToPose(
                                                drive, new Pose2d(new Translation2d(6.0, 6.0), new Rotation2d())));

                OIController.intake()
                                .and(shootingTrigger.negate())
                                .whileTrue(Commands.parallel(intake.intakeRollerCommand(), indexer.index(),
                                                intake.extendIntake()))
